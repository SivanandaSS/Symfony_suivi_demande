 ...
 */
final class Version20250826082357 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE devis (id INT AUTO_INCREMENT NOT NULL, total NUMERIC(10, 2) NOT NULL, numero VARCHAR(255) NOT NULL, statut VARCHAR(255) NOT NULL, date_devis DATE NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE facture (id INT AUTO_INCREMENT NOT NULL, devis_id INT NOT NULL, facture VARCHAR(255) DEFAULT NULL, numero VARCHAR(255) NOT NULL, date_emission DATE NOT NULL, paiement TINYINT(1) NOT NULL, total NUMERIC(10, 2) NOT NULL, UNIQUE INDEX UNIQ_FE86641041DEFADA (devis_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
